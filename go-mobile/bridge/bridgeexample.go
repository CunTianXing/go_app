...
func init() {
	bridge.RegisterFunc("github.com/CunTianXing/go_app/go-mobile/bridge NewBridgeView", func() view.View {
		return NewBridgeView()
	})
}

func init() {
	bridge.RegisterFunc("github.com/CunTianXing/go_app/go-mobile/bridge callWithGoValues", func(v int64) string {
		return fmt.Sprintf("Call with Go values:%v", v)
	})
	bridge.RegisterFunc("github.com/CunTianXing/go_app/go-mobile/bridge callWithForeignValues", func(v *bridge.Value) *bridge.Value {
