...
func main() {
	...
	// ffmpeg -f avfoundation -pixel_format uyvy422 -i "1" -f flv rtmp://localhost/screen

	//ffmpeg -f avfoundation -i "1:0" -vcodec libx264 -preset ultrafast -acodec libmp3lame -ar 44100 -ac 1 -f flv rtmp://localhost/screen
