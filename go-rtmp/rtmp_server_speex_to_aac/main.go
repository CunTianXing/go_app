...
//brew install ffmpeg --with-speex --with-fdk-aac --with-ffplay --with-freetype --with-libass --with-libvorbis --with-libvpx --with-opus --with-x265 --with-tools --with-fontconfig --with-libquvi
