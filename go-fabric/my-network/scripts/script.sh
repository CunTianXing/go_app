...
echo
echo "Build your my network (BYFN) end-to-end test"
echo
CHANNEL_NAME="$1"
DELAY="$2"
LANGUAGE="$3"
...
CC_SRC_PATH="github.com/chaincode/go/first-network/"
...
createChannel() {
  ...
  if [ -z "$CORE_PEER_TLS_ENABLED" -o "$CORE_PEER_TLS_ENABLED" = "false" ]; then
		...
		echo "##=peer channel create -o orderer.example.com:7050 -c $CHANNEL_NAME -f ./channel-artifacts/channel.tx --tls $CORE_PEER_TLS_ENABLED --cafile $ORDERER_CA >&log.txt=##"
	fi
	res=$?
	cat log.txt
...
# instantiateChaincode 2 #dev-peer0.org2.example.com-mycc-1.0
#
# #Query on chaincode on Peer0/Org1
# echo "Querying chaincode on org1/peer0..."
# chaincodeQuery 0 100  # dev-peer0.org1.example.com-mycc-1.0
#
...
# chaincodeQuery 3 90 # dev-peer1.org2.example.com-mycc-1.0
